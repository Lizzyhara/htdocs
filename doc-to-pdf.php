...
if (curl_errno($curl) == 0)
{
    ...
    if ($status_code == 200)
    {
        ...
        if (!isset($json["error"]) || $json["error"] == false)
        {
            ...
            if (curl_errno($curl) == 0)
            {
                ...
                else
                {
                    ...
                    header("Location: templates/sample.php?error= $status_code" );
                     exit();;
                }
            }
            else
            {
                // Display CURL error
                header("Location: templates/sample.php?error=" .curl_error($curl) );
                 exit();;
            }
        }
        else
        {
            ...
            header("Location: templates/sample.php?error=" . $json["message"]);
            exit();
        }
    }
    else
